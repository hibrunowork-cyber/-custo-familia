...
function filtrarCategoriasPrincipais(categoriasOriginais) {
    ...
    categoriasFiltradas = categoriasFiltradas.map(cat => {
        ...
        const itensFiltrados = cat.itens.filter(item => {
            ...
            // Debug temporário para item WEBVIP
            if (item.subcategoria && item.subcategoria.includes('WEBVIP')) {
                console.log('Item WEBVIP encontrado:', {
                    isAnual,
                    filtroAnualAtivo,
                    filtroCobranca,
            ...
            if (filtroAnualAtivo && isAnual) {
                ...
                // Debug temporário
                if (item.subcategoria && item.subcategoria.includes('WEBVIP')) {
                    console.log('Item WEBVIP - filtros:', {
                        passaCarteira,
                        passaFonte,
                        passaBusca,
                        filtroCarteira,
                        filtroFonte,
                        itemCarteira: item.carteira,
                        itemFonte: item.fonte
                    });
                }
