...
function inicializarDashboard(dados) {
    ...
    document.getElementById('filterCategoriaParcelas').addEventListener('change', () => {
        sincronizarFiltros('categoria');
        filtrarTudo(categoriasArray);
    });
    document.getElementById('filterFonteParcelas').addEventListener('change', () => {
        sincronizarFiltros('fonte');
        filtrarTudo(categoriasArray);
    });
    document.getElementById('filterMesParcelas').addEventListener('change', () => {
