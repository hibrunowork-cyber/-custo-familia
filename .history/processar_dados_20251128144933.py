...
def processar_dados_07():
    ...
    # Ler arquivo DADOS_07_COM_ORIGINAL.txt se existir, senão DADOS_07.txt
    arquivo = 'src/DADOS_07_COM_ORIGINAL.txt' if os.path.exists('src/DADOS_07_COM_ORIGINAL.txt') else 'src/DADOS_07.txt'
