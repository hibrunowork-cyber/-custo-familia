...
def processar_linha(linha):
    ...
    # Verificar formato: pode ter 6 colunas (com tag fixa), 5 colunas (sem tag), ou 4 colunas (formato antigo)
    despesa_fixa = None
    
    if len(partes) == 6:
        fonte, gasto, gasto_original, valor_str, parcelas_str, despesa_fixa = partes
    elif len(partes) == 5:
    ...
    return {
        ...
        "despesa_fixa": despesa_fixa.strip() if despesa_fixa else None,
        "valor": valor,
