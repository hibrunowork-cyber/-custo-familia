...
def processar_linha(linha):
    ...
    # Se for frequência mensal E NÃO for parcelada, repete todo mês a partir de dezembro 2025
    if frequencia == 'mensal' and not (parcela_atual and parcelas_total):
        # Começar em dezembro de 2025
        mes_inicio = 12
        ano_inicio = 2025
        
        # Gerar 12 meses de recorrência (dezembro 2025 até novembro 2026)
        for i in range(12):
    ...
    elif parcela_atual and parcelas_total:
...
def processar_dados_07():
    ...
    # Ler arquivo OUTCOME.txt
    arquivo = 'src/OUTCOME.txt'
